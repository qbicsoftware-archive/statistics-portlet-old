 ...
 * @author fhanssen
 */
public class ProjectTechnologiesPresenter extends ATabPresenter<PieChartModel, PieView> {

    public ProjectTechnologiesPresenter(StatisticsViewUI mainView, ChartConfig projectsConfig){
