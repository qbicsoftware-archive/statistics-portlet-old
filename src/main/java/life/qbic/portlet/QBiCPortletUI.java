...
public abstract class QBiCPortletUI extends UI {
    ...
    private final static String PORTLET_REPOSITORY_URL = "http://github.com/qbicsoftware/statistics-portlet";
    ...
    protected final void init(final VaadinRequest request) {
        LOG.info("Initializing portlet statistics-portlet, version " + PORTLET_VERSION);
